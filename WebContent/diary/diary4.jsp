...
<style type="text/css">
	...
	.today{ 
		width:100px; height:60px; border:1px solid #ccc; text-align:right; font-weight:bold; vertical-align:top; padding:5px 10px; box-sizing:border-box; color:blue; background-color:lightpink;
	 }
	/* 달력 설정 끝 */
...
<body>
	<div id="wrap">
		...
		<div id="container">
			...
			%>
			<form action="diary3.jsp" method="post" name="diaryFrm">
			...
			<div id="diaryTitle">
				...
				<a href="diary3.jsp"><img src="images/btn_today.png" title="오늘" /></a>
			</div>
			<div id="diaryContent">
				<table id="diaryTab" >
					<tr>
					...
					<tr>
						...
						<%
								...
								case Calendar.SATURDAY:
									...
									break;
								default:
									if( tempDay == today && Calendar.getInstance().get(Calendar.MONTH)+1 == nowMonth){
										dayClass="todayColor";
									} else{
										dayClass="weekColor";
									} // end else
