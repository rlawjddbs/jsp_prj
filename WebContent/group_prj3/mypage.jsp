...
<body>
	<div id="wrap">
		...
		<section>
			<article>
				<h1 id="board_title">회원 정보 수정</h1>
				<div id="contentWrap">
					<form name="frm" id="frm">
						<h3><label>아이디</label></h3>
						<input type="text" placeholder="아이디는 변경할 수 없습니다." name="userId" readonly="readonly" id="userId" />
						<h3><label>이름</label></h3>
						<input type="text" placeholder="변경할 이름을 입력해주세요." name="userName" id="userName" />
						<h3><label>생년월일</label></h3>
						<input type="text" placeholder="YYYY" name="birthYear" id="birthYear" maxlength="4" />년
						<input type="text" placeholder="MM" name="birthYear" id="birthMonth" maxlength="2" />월
						<input type="text" placeholder="DD" name="birthYear" id="birthDay" maxlength="2" />일
						<h3><label>핸드폰 번호</label></h3>
						<input type="text" placeholder="000-0000-0000" name="phone" id="phone" />
						<div id="btnGroup">
